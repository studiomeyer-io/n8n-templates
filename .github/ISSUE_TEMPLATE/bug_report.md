...
A clear, plain-text description. Include the n8n version, the community-node version (`n8n-nodes-studiomeyer-memory@x.x.x`), and the LLM provider you picked.
...
- n8n version:
- Custom-node version (`n8n-nodes-studiomeyer-memory`):
- Provider used (OpenAI / Anthropic / other):
- Hosting (Cloud / self-hosted Docker / npm):
